"""this is my python project for computer graphics lab....i am going to make 
a aim trainer game for this project using pyhton and some concepts i learned in my lab!!
this code has no lives section"""
import math
import math
import random
import time
...
def draw_top_bar(win, elapsed_time, targets_pressed, clicks):
...
def main():
    ...
    while run:
        ...
        draw(WIN, targets)
        draw_top_bar(WIN, elapsed_time, targets_pressed, clicks)
        pygame.display.update()
